...
def drawPressKeyMsg2():
    pressKeySurf = BASICFONT.render('Press a key to quit.', True, DARKGRAY)
    pressKeyRect = pressKeySurf.get_rect()
    pressKeyRect.topleft = (WINDOWWIDTH - 200, WINDOWHEIGHT - 30)
    DISPLAYSURF.blit(pressKeySurf, pressKeyRect)
...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('Ready', True, WHITE, DARKGREEN)
    titleSurf2 = titleFont.render('Ready', True, GREEN)
...
def terminate():
    #quit the game without quit python
    pygame.display.quit()
    pygame.quit()
